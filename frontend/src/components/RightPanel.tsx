    ...
    <aside style={styles.panel}>
      ...
      <div style={styles.section}>
        <div style={styles.sectionHeader}>
          ...
          <button style={styles.menuBtn} title="Options">···</button>
        </div>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.countdownWrap}>
          ...
          <div style={styles.countdownSubject}>
            {activeSubject ? `${activeSubject.name} · May 24` : "No exam set"}
          </div>
        </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  sectionTitle: { fontFamily: "var(--font-header)", fontSize: 8, letterSpacing: "0.14em", textTransform: "uppercase" as const, color: "var(--gold-dim)", flex: 1 },
  sectionTitlePlain: { fontFamily: "var(--font-header)", fontSize: 8, letterSpacing: "0.14em", textTransform: "uppercase" as const, color: "var(--gold-dim)", marginBottom: 2 },
  menuBtn:      { background: "none", border: "none", color: "var(--text-dim)", cursor: "pointer", fontSize: 10, letterSpacing: "0.05em", padding: "0 2px", lineHeight: 1 },
