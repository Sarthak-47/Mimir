...
const styles: Record<string, React.CSSProperties> = {
  ...
  sectionRune:     { fontFamily: "var(--font-header)", fontSize: 12, color: "var(--gold-dim)" },
  sectionTitle:    { fontFamily: "var(--font-header)", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "var(--gold-dim)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" as const },
  sectionTitlePlain: { fontFamily: "var(--font-header)", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "var(--gold-dim)", marginBottom: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" as const },
  ...
  statBox:         { padding: "8px 10px", background: "var(--stone-3)", marginTop: 6 },
  statLabel:       { fontFamily: "var(--font-header)", fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase" as const, color: "var(--text-dim)", marginBottom: 2 },
  statNumber:      { fontFamily: "var(--font-header)", fontSize: 26, fontWeight: 700, color: "var(--gold-bright)", lineHeight: 1 },
  statSub:         { fontFamily: "var(--font-body)", fontSize: 11, fontStyle: "italic", color: "var(--text-dim)", marginTop: 2 },
  dimText:         { fontFamily: "var(--font-body)", fontSize: 12, fontStyle: "italic", color: "var(--text-dim)", padding: "3px 0" },
  weakRow:         { display: "flex", alignItems: "center", gap: 6, marginBottom: 7 },
  weakTopic:       { fontFamily: "var(--font-body)", fontSize: 12, color: "var(--text-secondary)", flex: 1, whiteSpace: "nowrap" as const, overflow: "hidden", textOverflow: "ellipsis" },
  weakBarTrack:    { width: 44, height: 3, background: "var(--stone-3)", flexShrink: 0 },
  weakBarFill:     { height: "100%", transition: "width 0.3s ease" },
  countdownWrap:   { textAlign: "center" as const, padding: "4px 0 6px" },
  countdownNumber: { fontFamily: "var(--font-header)", fontSize: 38, fontWeight: 700, color: "var(--gold-bright)", lineHeight: 1 },
  countdownLabel:  { fontFamily: "var(--font-header)", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: "var(--text-dim)", marginTop: 3 },
  countdownSubject:{ fontFamily: "var(--font-body)", fontSize: 12, fontStyle: "italic", color: "var(--gold-dim)", marginTop: 3 },
  clearExamBtn:    { background: "none", border: "none", fontFamily: "var(--font-body)", fontSize: 11, fontStyle: "italic", color: "var(--text-dim)", cursor: "pointer", padding: "2px 0", width: "100%", textAlign: "right" as const, marginTop: 2 },
  activeSubject:   { display: "flex", alignItems: "center", gap: 6, padding: "5px 8px", background: "var(--stone-3)", border: "1px solid var(--green-dark)" },
  diamond:         { display: "inline-block", width: 7, height: 7, transform: "rotate(45deg)", flexShrink: 0 },
  activeSubjectName: { fontFamily: "var(--font-body)", fontSize: 13, color: "var(--text-primary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" as const },
};
