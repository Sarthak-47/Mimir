...
const styles: Record<string, React.CSSProperties> = {
  ...
  sectionTitle:    { fontFamily: "var(--font-header)", fontSize: 8, letterSpacing: "0.14em", textTransform: "uppercase" as const, color: "var(--gold-dim)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" as const },
  sectionTitlePlain: { fontFamily: "var(--font-header)", fontSize: 8, letterSpacing: "0.14em", textTransform: "uppercase" as const, color: "var(--gold-dim)", marginBottom: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" as const },
