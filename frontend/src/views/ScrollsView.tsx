      ...
      <div style={styles.pageHeader}>
        ...
        <div style={{ marginLeft: "auto" }}>
          ...
          <button
            ...
            disabled={uploading}
          >
            {uploading ? "Uploading…" : "+ Upload Scroll"}
          </button>
        </div>
      </div>
      ...
      {!loading && files.length > 0 && (
        <div style={styles.fileList}>
          ...
          <div style={styles.headerRow}>
            ...
            <span style={{ ...styles.colHeader, width: 70 }}>Status</span>
          </div>

          {files.map((f) => (
            <div key={f.id} style={styles.fileRow}>
              <span style={styles.fileIcon}>{extIcon(f.filename)}</span>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  emptyRune:    { fontFamily: "var(--font-header)", fontSize: 40, color: "var(--green-dark)", lineHeight: 1 },
  emptyTitle:   { fontFamily: "var(--font-header)", fontSize: 12, letterSpacing: "0.14em", color: "var(--text-dim)" },
  emptyText:    { fontFamily: "var(--font-body)", fontSize: 12, fontStyle: "italic", color: "var(--text-dim)", maxWidth: 280, lineHeight: 1.6 },
  ...
  fileIcon:     { fontSize: 14, flexShrink: 0, lineHeight: 1 },
  ...
  fileSubject:  { fontFamily: "var(--font-body)", fontSize: 10, color: "var(--text-dim)", width: 100, flexShrink: 0, whiteSpace: "nowrap" as const, overflow: "hidden", textOverflow: "ellipsis" },
